...
<body>
    ...
    <header class="header-area">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarOne">
                                <ul class="navbar-nav m-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#service">MENGAPA KAMI</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div id="home" class="header-hero bg_cover" style="background-image: url(/images/laundry.jpg)">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="header-content text-center">
                            ...
                            <ul class="header-btn">
                                <li><a class="main-btn btn-one" href="#">Pesan Sekarang !</a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-10">
                        ...
                        <p class="text">Kami adalah layanan pemesanan laundry online dimana kami mewadahi jasa anda sebagai pengusaha laundry dan pembeli sebagai aset anda</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-10">
                        ...
                        <p class="text">DATANG ATAU ANTAR ?<br>Kami siap melayani anda keduanya kapanpun dan dimanapun</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
    ...
    <section id="contact" class="contact-area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-10">
                        <h4 class="title">DAFTARKAN DIRI ANDA</h4>
                        <p class="text">Apakah anda datang sebagai pembeli atau penjual jasa Laundry? <br> Kami siap menerima anda</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
